...
// Регистрация пользователя, вход пользователя на сайт
// Валидация при регистрации и входе пользователя
...
router.post(
    ...
    try {
        ...
        await user.save()
        // выводим сообщение от сервера, что пользователь создан
...
router.post(
    '/login',
    // задаем параметры для проверки введенных данных
    [
